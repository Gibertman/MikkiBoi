...
IFontDisp = Font
__all__ = [ 'VgaColor', 'OLE_YPOS_PIXELS', 'FONTSTRIKETHROUGH',
           'FONTITALIC', 'IFont', 'IPictureDisp', 'OLE_COLOR',
           'OLE_CANCELBOOL', 'OLE_XPOS_HIMETRIC', 'Unchecked',
           'FONTBOLD', 'OLE_OPTEXCLUSIVE', 'FONTUNDERSCORE', 'Color',
           'OLE_XSIZE_HIMETRIC', 'OLE_XPOS_PIXELS',
           'OLE_YPOS_CONTAINER', 'Default', 'OLE_XSIZE_CONTAINER',
           'Gray', 'OLE_XSIZE_PIXELS', 'Picture', 'StdFont',
           'StdPicture', 'Checked', 'OLE_YSIZE_HIMETRIC', 'IPicture',
           'IFontDisp', 'OLE_ENABLEDEFAULTBOOL', 'IFontEventsDisp',
           'LoadPictureConstants', 'OLE_HANDLE', 'OLE_XPOS_CONTAINER',
           'Monochrome', 'FONTSIZE', 'OLE_TRISTATE', 'FontEvents',
           'OLE_YSIZE_CONTAINER', 'OLE_YSIZE_PIXELS',
           'OLE_YPOS_HIMETRIC', 'FONTNAME', 'Font']
